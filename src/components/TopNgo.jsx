        ...
        <div className="container">
            <div className="row">
                ...
                <div className="col-lg-12 col-12 text-center mb-4">
                    <h2>Top NGOs Nearby</h2>
                </div>

                <div className="col-lg-4 col-md-6 col-12 mb-4 mb-lg-0">
                    <div className="custom-block-wrap">
                        <img src="images/causes/group-african-kids-paying-attention-className.jpg" className="custom-block-image img-fluid" alt=""/>
                        ...
                        <div className="custom-block">
                            ...
                            <NavLink to="donate.html" className="custom-btn btn">Donate now</NavLink>
                        </div>
                    </div>
                </div>
